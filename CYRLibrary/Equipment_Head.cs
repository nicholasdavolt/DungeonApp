...
{
    public class Equipment_Head : Item
    {
        ...
        public Equipment_Head(string name, bool isConsumable, int bonusHitChance, int bonusBlock, int bonusToughness, EquipLocations location) : base(name, isConsumable)
        {
