...
{
    public class Equipment_Body : Item
    {
        ...
        public Equipment_Body(string name, bool isConsumable, int bonusHitChance, int bonusBlock, int bonusToughness, EquipLocations location) : base(name, isConsumable)
        {
